...
# Prepare the prompt to send to GPT-4 model
prompt = (
    f"The following is an original prompt and several responses to it. Please rank the responses based on their coherance (fluid and non segmented), relevance, completeness, and quality.\n\n"
    f"Original Prompt:\n{original_prompt}\n\n"
    f"Responses:\n\n{all_file_details}"
)
print(prompt)
